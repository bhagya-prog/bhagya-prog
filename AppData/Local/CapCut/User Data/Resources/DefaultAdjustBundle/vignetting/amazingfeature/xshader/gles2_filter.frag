...
void main(void)
{
    vec4 mainColor = texture2D(mainTexture, uv0);
    vec4 inputColor = texture2D(inputTexture, uv0) * intensity;
    vec4 resColor;
    resColor = vec4(blendFunc(mainColor.rgb, inputColor.rgb, inputColor.a, 15), mainColor.a);
