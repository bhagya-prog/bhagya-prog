...
fragment main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer, texture2d<float> baseTex [[texture(0)]], texture2d<float> _MainTex [[texture(1)]], sampler baseTexSmplr [[sampler(0)]], sampler _MainTexSmplr [[sampler(1)]])
{
    ...
    if (_278)
    {
        ...
        if (_798.x < 0.5)
        {
            _810 = (2.0 * _798.x) * _804.x;
        }
        else
        {
            _810 = fma((1.0 - _798.x) * (-2.0), 1.0 - _804.x, 1.0);
        }
        float _811;
        if (_798.y < 0.5)
        {
            _811 = (2.0 * _798.y) * _804.y;
        }
        else
        {
            _811 = fma((1.0 - _798.y) * (-2.0), 1.0 - _804.y, 1.0);
        }
        float _812;
        if (_798.z < 0.5)
        {
            _812 = (2.0 * _798.z) * _804.z;
        }
        else
        {
            _812 = fma((1.0 - _798.z) * (-2.0), 1.0 - _804.z, 1.0);
        }
    ...
    else
    {
        ...
        do
        {
            ...
            if (_590 < _545)
            {
                _807 = fma(_590, _804.x, fma(_556, 1.0 - _804.w, _804.x * (1.0 - _545)));
                break;
            }
        ...
        do
        {
            ...
            if (_635 < _545)
            {
                _808 = fma(_635, _804.y, fma(_565, 1.0 - _804.w, _804.y * (1.0 - _545)));
                break;
            }
        ...
        do
        {
            ...
            if (_680 < _545)
            {
                _809 = fma(_680, _804.z, fma(_574, 1.0 - _804.w, _804.z * (1.0 - _545)));
                break;
            }
